...
| improved_trailing_stop            |            12 |   0.416667 |     1.12559    |      -0.534489 |                1.66667 |        2.69813  |
...
- external_ipo_rows_present: 15
- external_ipo_subscription_field_present: 10
- external_grey_rows_present: 14
- external_grey_value_present: 12
- external_grey_values_approximate: 3
- external_grey_values_reported_exact: 9

> 覆盖率/可靠性口径：IPO **行覆盖** 15/65（含发行价/保荐人/行业/来源），其中**超购字段**覆盖 10/65（其余为孖展口径或未单列，留空不填 0）；暗盘 12 个数值中 9 个为媒体明确收盘价、3 个为近似（取中值/区间/升幅描述，已在 source_note 标注）。
...
| cost_scale   | trade_count   | win_rate           | average_return         | average_win         | average_loss         | profit_factor      | total_return         | max_drawdown        | turnover           | average_holding_days   |
|:-------------|:--------------|:-------------------|:-----------------------|:--------------------|:---------------------|:-------------------|:---------------------|:--------------------|:-------------------|:-----------------------|
| 0.5          | 27.0          | 0.3333333333333333 | 0.004401284528240699   | 0.16362095797421738 | -0.07520855219474763 | 1.0876815182568291 | -0.05876618931552291 | -0.3365369686527621 | 2698859.6054249993 | 1.5555555555555556     |
| 1.0          | 27.0          | 0.3333333333333333 | 0.002095395986207328   | 0.16097486891255702 | -0.07734434047696753 | 1.0405638737031024 | -0.11548809548811867 | -0.3526158724384677 | 2699261.2546899994 | 1.5555555555555556     |
| 2.0          | 27.0          | 0.3333333333333333 | -0.0025118378919723517 | 0.1556888346966277  | -0.08161217418627238 | 0.953547668991779  | -0.21912705070467786 | -0.3884514498839292 | 2698969.23414      | 1.5555555555555556     |

**improved_trailing_stop**

| cost_scale   | trade_count   | win_rate           | average_return      | average_win         | average_loss         | profit_factor      | total_return       | max_drawdown        | turnover           | average_holding_days   |
|:-------------|:--------------|:-------------------|:--------------------|:--------------------|:---------------------|:-------------------|:-------------------|:--------------------|:-------------------|:-----------------------|
| 0.5          | 12.0          | 0.4166666666666667 | 0.1052142858030608  | 0.39443511938158143 | -0.10137202389588248 | 2.778180168041163  | 1.188550957749574  | -0.526789333728233  | 1198743.182055     | 1.6666666666666667     |
| 1.0          | 12.0          | 0.4166666666666667 | 0.10251656193843099 | 0.390906087713223   | -0.10347595647213478 | 2.698132071554048  | 1.1255874139599502 | -0.53448949635541   | 1199052.7548999998 | 1.6666666666666667     |
| 2.0          | 12.0          | 0.3333333333333333 | 0.09712889313860883 | 0.47999337076441156 | -0.09430334567429254 | 2.5456311238066935 | 1.0047675739691466 | -0.5495550631362326 | 1199246.07474      | 1.6666666666666667     |
...
| trailing_stop_pct   | trade_count   | win_rate   | average_return   | total_return   | profit_factor   |
|:--------------------|:--------------|:-----------|:-----------------|:---------------|:----------------|
| 0.08                | 12.0          | 0.4167     | 0.1215           | 1.6323         | 3.4755          |
| 0.10                | 12.0          | 0.4167     | 0.1025           | 1.1256         | 2.6981          |
| 0.15                | 12.0          | 0.4167     | 0.1066           | 0.9732         | 2.5691          |
| 0.20                | 12.0          | 0.3333     | 0.046            | 0.0158         | 1.4728          |
...
| improved_trailing_stop            | 112.6%         | [-53.2%, 1237.0%] | —      |
...
| 检验                              | 值     | 含义                                       |
|:--------------------------------|:------|:-----------------------------------------|
| max-statistic 置换 p（White RC 风格） | 0.138 | 最佳档 total_return=42.8% 在 14 个配置多重比较下的显著性 |
| Holm 最小校正 p                     | 0.396 | 各门槛单独置换 p 经 Holm step-down 后的最小值         |
| Deflated Sharpe Ratio           | 0.000 | improved 12 笔；N=14 试验校正后 Sharpe 是否显著     |
...
- **Improved+Trailing（增强，追踪止损让赢家跑）**：12 笔，胜率 41.7%，总收益 112.56%，profit_factor 2.70；收益随 trail **单调**（机制性、非尖峰），是出场机制改进而非选股因子；但靠单一普涨窗口『让趋势跑』天然占优，外推到下跌/震荡市存疑。
...
- **尾部集中度（improved_trailing_stop）**：02723.HK(+88%)、02513.HK(+60%) 贡献了几乎全部收益；剔除 top-2 赢家后 total_return = -29.3%（全样本 112.6%）——收益由少数极热标的驱动、非普适 alpha，呼应单一普涨窗口的 Limitations。
